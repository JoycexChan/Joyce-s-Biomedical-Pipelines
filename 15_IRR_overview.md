...
The purpose of the probe is to determine whether the AI is actually using the **shared definition and shared context** (Domain-specific ability interpretation or Conversational-exclamation interpretation), rather than automatically reverting to its default semantic interpretation (Absolute / self-aggrandizing interpretation).
